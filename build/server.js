...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _TableCss = __webpack_require__(42);
      ...
      value: function render() {
        return _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            'tbody',
            null,
            _react2['default'].createElement(_Tr2['default'], { data: this.props.data })
          )
        );
      }
    }], [{
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var App = (function (_Component) {
    ...
    _createClass(App, [{
      key: 'render',
      value: function render() {
        var datas = [{ key: "Sporting Goods", price: "$49.99", stocked: true, name: "Football" }, { key: "Sporting Goods", price: "$9.99", stocked: true, name: "Baseball" }, { key: "Sporting Goods", price: "$29.99", stocked: false, name: "Basketball" }, { key: "Electronics", price: "$99.99", stocked: true, name: "iPod Touch" }, { key: "Electronics", price: "$399.99", stocked: false, name: "iPhone 5" }, { key: "Electronics", price: "$199.99", stocked: true, name: "Nexus 7" }];
        return !this.props.error ? _react2['default'].createElement(
          'div',
          null,
          _react2['default'].createElement(_Table2['default'], { data: datas })
        ) : this.props.children;
      }
    }], [{
      key: 'propTypes',
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _TrCss = __webpack_require__(43);
  
  var _TrCss2 = _interopRequireDefault(_TrCss);
  
  var _Td = __webpack_require__(59);
  ...
  var Tr = (function (_Component) {
    ...
    function Tr() {
      ...
      _get(Object.getPrototypeOf(_Tr.prototype), 'constructor', this).apply(this, arguments);
    }
    ...
    _createClass(Tr, [{
      ...
      value: function render() {
        var td = this.props.data.map(function (data, i) {
          return _react2['default'].createElement(_Td2['default'], { key: i, data: data });
        }, this);
    ...
    var _Tr = Tr;
    Tr = (0, _decoratorsWithStyles2['default'])(_TrCss2['default'])(Tr) || Tr;
    return Tr;
  })(_react.Component);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _componentsContentPage = __webpack_require__(15);
  
  var _componentsContentPage2 = _interopRequireDefault(_componentsContentPage);
  
  var _componentsContactPage = __webpack_require__(14);
  ...
  var _componentsTable = __webpack_require__(6);
  ...
  var router = new _reactRoutingSrcRouter2['default'](function (on) {
    ...
    on('/table', function callee$1$0() {
      return regeneratorRuntime.async(function callee$1$0$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            return context$2$0.abrupt('return', _react2['default'].createElement(_componentsTable2['default'], null));
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _TdCss = __webpack_require__(60);
  
  var _TdCss2 = _interopRequireDefault(_TdCss);
  
  var _Attr = __webpack_require__(61);
  ...
  var Td = (function (_Component) {
    ...
    _createClass(Td, [{
      key: 'render',
      value: function render() {
        return (_react2['default'].createElement(_Attr2['default'], { data: this.props.data.key }), _react2['default'].createElement(_Attr2['default'], { data: this.props.data.name }), _react2['default'].createElement(_Attr2['default'], { data: this.props.data.stock }), _react2['default'].createElement(_Attr2['default'], { data: this.props.data.price }));
      }
    }], [{
      key: 'propTypes',
      value: {
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _AttrCss = __webpack_require__(62);
  
  var _AttrCss2 = _interopRequireDefault(_AttrCss);
  
  var Attr = (function (_Component) {
    _inherits(Attr, _Component);
  
    function Attr() {
      _classCallCheck(this, _Attr);
  
      _get(Object.getPrototypeOf(_Attr.prototype), 'constructor', this).apply(this, arguments);
    }
    ...
    var _Attr = Attr;
    Attr = (0, _decoratorsWithStyles2['default'])(_AttrCss2['default'])(Attr) || Attr;
    return Attr;
  })(_react.Component);
